...
def run_experiments(experiment_file, num_monte_carlo_runs=None,
    ...
    if 'settings' in experiment_params:
        ...
        # dict(base_params.items()).update(dict(experiment_params['settings'].items()))
        base_params.update(experiment_params['settings'])
        # base_params = {**base_params, **experiment_params['settings']}
    ...
    for dataset_cfg in experiment_params['datasets']:
        ...
        if os.path.exists(dataset_params_file):
            ...
            # dict(cur_params.items()).update(dict(dataset_params.items()))
            # cur_params = {**cur_params, **dataset_params}
